...
cd C:\GLOVER\data\myanmar\AQD\BR_Aqd_Sept17\DeadEndStation
aqd=aqdlr2x('BRdead01.hdr');
...
offset = nanmean(aqd.atm_pres(1:100)) - nanmean(aqd.pres(1:100));
...
aqd.ssc1(abs(aqd.ssc1(1:end-1)-aqd.ssc1(2:end))>20)=NaN;
aqd.ssc2(abs(aqd.ssc2(1:end-1)-aqd.ssc2(2:end))>20)=NaN;
