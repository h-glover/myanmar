...
load BR_Sept17_Spring_adcp.mat
c=1;
UpDists=[];
DownDists=[];
AllVels=[];
...
save BR_Sept17_Spring.mat adcp
...
title('Yangon River | Spring Tide | High Discharge','fontsize',14)
ylabel(c, 'Downstream Velocity (cm s^-^1)','fontsize',14);
xlabel('Cross-Channel Distance (m)','fontsize',t14);
